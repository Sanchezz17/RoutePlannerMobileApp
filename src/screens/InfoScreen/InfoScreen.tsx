...
import AlertIcon from '../../components/icons/Cards/AlertIcon';
                ...
                <View style={styles.sectionContainer}>
                    ...
                    {!currentUserHasNoRole && (
                        <View>
                            ...
                            {(currentUserIsSuperuser || currentUserIsAdmin) && (
                                <View>
                                    <Text style={styles.paragraph}>
                                        Новые пользователи, установившие
                                        приложение, будут отображаться на
                                        вкладке “Заявки”. Если принять заявку,
                                        пользователь сможет задавать себе график
                                        работы, видеть информацию о встречах и
                                        отобразится на вкладке “Менеджеры”
                                    </Text>
                                    <Text style={styles.paragraph}>
                                        На вкладке “Менеджеры” можно
                                        просматривать список работников, видеть
                                        их контакты, графики и маршруты
                                    </Text>
                                    <Text style={styles.paragraph}>
                                        Добавить нового клиента можно с помощью
                                        вкладки “Клиенты”. На этом же экране
                                        вносится информация о встречах.
                                    </Text>
                                    <Text style={styles.paragraph}>
                                        На вкладке “Встречи” можно редактировать
                                        и удалять назначенные встречи
                                    </Text>
                                </View>
                            )}
                            {(currentUserIsSuperuser ||
                                ...
                                <View>
                                    <Text style={styles.paragraph}>
                                        Для того, чтобы получить маршрут на
                                        сегодня, необходимо задать время работы
                                        на вкладке “График”
                                    </Text>
                                    <Text style={styles.paragraph}>
                                        Через некоторое время после задания
                                        графика, сформированное расписание
                                        встреч отобразится на вкладке “Маршрут”
                                    </Text>
                                </View>
                            )}
                        </View>
                    ...
                    {currentUserHasNoRole && (
                        <View>
                            ...
                            <Text style={styles.paragraph}>
                                Администратор ещё не выдал вам права. Подождите
                                некоторое время или свяжитесь с администратором
                            </Text>
                        </View>
                    )}
                </View>
